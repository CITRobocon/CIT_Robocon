...
int main(){
    ...
    if ((OSW1&1) != 1){
        ...
        //followVirtualLine(p1, 0.7f, 0.65f);
        followVirtualLine(p1, 0.7f, 0.8f);
    
        while(moving()){wait(0.010);};
        double p7[4][2] = {{930, 1593}, {930, 1632}, {930, 1674}, {930, 1700}};
        //followVirtualLine(p7, 0.5f, 0.8f, 0.8f);
        //followVirtualLine(p7, 0.65f, 0.8f, 0.8f);
        followVirtualLine(p7, 0.8f, 0.9f, 0.9f);
        wait(0.10);
        putGA();
        ...
        //followVirtualLine(p2, 0.6f, 0.7f);
        followVirtualLine(p2, 0.7f, 0.8f);
        wait(1.0f);
        closeTable();
    
        double p3[4][2] = {{256, 2099}, {256, 2605}, {545, 2605}, {900, 2605}};
        //followVirtualLine(p3, 0.6f, 0.7f, 0.7f, 0.3f);
        //followVirtualLine(p3, 0.7f, 0.7f, 0.3f);
        followVirtualLine(p3, 0.8f, 0.8f, 0.3f);
        ...
        //followVirtualLine(p10, 0.7f, 0.4f);
        followVirtualLine(p10, 0.8f, 0.8f, 0.4f);
    }
    ...
    //followVirtualLine(p5, 0.6f, 0.7f);
    followVirtualLine(p5, 0.7f, 0.8f);
    double p8[4][2] = {{256, 2099}, {256, 1593}, {580, 1593}, {800, 1593}};
    //followVirtualLine(p8, 0.6f, 0.6f, 0.5f);
    //followVirtualLine(p8, 0.7f, 0.5f);
    followVirtualLine(p8, 0.8f, 0.7f);
    while(moving()){wait(0.010);}
    turnEast();
    invert();
    double p6[4][2] = {{800, 1593}, {930, 1593}, {1000, 1593}, {1100, 1593}};
    //followVirtualLine(p6, 0.5f, 0.5f, 0.3f);
    //followVirtualLine(p6, 0.6f, 0.5f, 0.3f);
    followVirtualLine(p6, 0.8f, 0.3f);
    lowerHandToReleaseA();
    ...
    //followVirtualLine(p8, 0.6f, 0.7f);
    followVirtualLine(p8, 0.7f, 0.8f);
    reverse(&p5[0][0]);
    p5[3][1] += 60;
    //followVirtualLine(p5, 0.6f, 0.6f, 0.3f);
    //followVirtualLine(p5, 0.7f, 0.7f, 0.4f);
    followVirtualLine(p5, 0.8f, 0.8f, 0.4f);
    ...
    reverse(&p5[0][0]);
    //followVirtualLine(p5, 0.5f, 0.6f, 0.6f);
    //followVirtualLine(p5, 0.6f, 07f);
    followVirtualLine(p5, 0.7f);
    reverse(&p8[0][0]);
    //followVirtualLine(p8, 0.6f, 0.6f, 0.5f);
    //followVirtualLine(p8, 0.7f, 0.5f);
    followVirtualLine(p8, 0.7f);
    ...
    //followVirtualLine(p6, 0.5f, 0.5f, 0.3f);
    //followVirtualLine(p6, 0.6f, 0.5f, 0.3f);
    followVirtualLine(p6, 0.7f, 0.3f);
    ...
    //followVirtualLine(p8, 0.6f, 0.6f, 0.5f);
    //followVirtualLine(p8, 0.7f, 0.5f);
    followVirtualLine(p8, 0.7f, 0.6f);
    ...
    //止まる時間
    wait(2.0);
    double p100[4][2] = {{800, 1593},{206, 1593}, {206, 1593}, {206, 206}};
    //第二引数
    followVirtualLine (p100, 0.5);
    while(moving()){wait(0.010);}
    while(1);
}
